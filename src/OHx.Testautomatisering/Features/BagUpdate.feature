...
Scenario: Een wegvak valt na de BAG upddate in een onbekende gemeente
...
Abstract Scenario: Een wegvak valt na de BAG update gedeeltelijk in de nieuwe gemeente. Het wegvak wordt niet meegenomen in de BAG update
Achtergrond: Deel van het wegvak ligt in de oude gemeente, wegvak blijft onder oude gemeente vallen
...
Scenario:  Een wegvak valt na de BAG update voor meer dan 2 meter in een nieuwe gemeente, minder dan 2 meter in de oude gemeente
...
Abstract Scenario: Een wegvak valt na de BAG update onder een nieuwe gemeente, de oude straat is nog niet bekend in BAG, de nieuwe straat is niet gevonden
...
Abstract Scenario: Minder dan 2 meter van een wegvak valt na de BAG update onder een nieuwe gemeente, de oude gemeente is nog niet bekend in BAG.
#Achtergrond: Het wegvak wordt niet in BAG update meegenomen, straat wordt wel opgevoerd
...
Scenario: Een wegvak valt na de BAG update onder een nieuwe gemeente, de nieuwe straat is niet gevonden en oude straatnaam is 'P', wegvak wordt niet meegenomen in de BAG update
...
Scenario: De gemeente in de straten tabel en de wegvakefemeridentabel komt niet overeen. Wegvak wordt niet meegenomen in de BAG update.
...
Scenario: Een wegvak met hectopunten valt na de BAG update onder een nieuwe gemeente, de hectopunten worden ook geupdatet
...
Scenario: Een wegvak met hectointervallen valt na de BAG update onder een nieuwe gemeente, de hectointervallen worden ook geupdatet
